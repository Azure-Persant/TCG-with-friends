...
BEGIN
  FOREACH fn IN ARRAY ARRAY[
    ...
    'app_set_holding(uuid,card_finish,uuid,card_condition,integer)',
    'app_set_condition(uuid,card_finish,uuid,card_condition,card_condition,integer)',
    'app_set_finish(uuid,uuid,card_condition,card_finish,card_finish,integer)',
    ...
    'app_create_collection_share(text,timestamptz)',
    'app_revoke_collection_share(uuid)',
    'app_delete_collection_share(uuid)',
